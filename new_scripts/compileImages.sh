...
#SBATCH --output=compileImages.out
#################
# a file for errors from the job
#SBATCH --error=compileImages.err
#################
...
source /scratch/groups/herschla/rna_map/scripts/new_scripts/python3_venv/bin/activate

# How to call python script:
# python3 compileImages.py <pattern> <conditions.txt> <Ntiles> <Image Directory>

python3 /scratch/groups/herschla/rna_map/scripts/new_scripts/compileImages.py $pattern $conditions_file $Ntiles $out_dir
