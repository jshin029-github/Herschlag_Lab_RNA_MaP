#!/bin/bash
#
# bash script to call plotOverallFluorQC.py using SLURM scheduler on Sherlock
#
#all commands that start with SBATCH contain commands that are just used by SLURM for scheduling
#################
#set a job name
#SBATCH --job-name=plotOverallFluorQC
#################
#a file for job output, you can check job progress
#SBATCH --output=plotOverallFluorQC.out
#################
# a file for errors from the job
#SBATCH --error=plotOverallFluorQC.err
#################
...
# How to call:
# Usage: sbatch plotOverallFluorQC.sh <experiment pattern>
#
...
outdir="$pattern"_OverallFluorQCPlots
...
python $rnamap_scripts/new_scripts/plotOverallFluorQC.py $green $red $cond $outdir
