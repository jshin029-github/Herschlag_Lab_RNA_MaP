...
# Usage: python makeClusterHeatmap.py [CPseries Template] [N Tiles] [color]

#### Change the following variables before running: ####
# Set folder names of green images
green_folders = [
"14_equilibrium2p7nM_InvertMut2_green" ,
"15_equilibrium8p2nM_green", 
"15_redo_equilibrium8p2nM_green", 
...
for tileno in range(1, NTiles+1):
    j = 0
