...
template=$1           # Template name of CPseries filesc
ntile=$2                                       # subtiles no
color=$3                                   # green or red channel images to plot
####################################################

pyth $rnamap_scripts/new_scripts/makeClusterHeatmapSingle.py $template $ntile $color
