...
#################
#set a job name  
#SBATCH --job-name=singleClusterFits.sh
#################  
#a file for job output, you can check job progress
#SBATCH --output=singleClusterFits.out
#################
# a file for errors from the job
#SBATCH --error=singleClusterFits.err
#################
...
python $rnamap_scripts/array_processing_tools/bin/singleClusterFits.py -b anyRNA_normed_AllRed.CPseries.gz -x concentrations_corrected.txt -out anyRNA_normed_AllRed.CPfitted.gz
