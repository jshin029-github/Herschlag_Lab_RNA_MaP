...
#################
#set a job name  
#SBATCH --job-name=plotBSF
#################  
#a file for job output, you can check job progress
#SBATCH --output=plotBSF.out
#################
# a file for errors from the job
#SBATCH --error=plotBSF.err
#################
...
# Usage: python plotBootstrapFits.py [CPvariant] [plotdir]

######### Change the following settings before running #########
cpvar="normed_anyRNA_Bootstrapped.CPvariant.gz"    # name of CPfitted.gz file from Bootstrapped fit
plotdir="BSFPlots"                      # name of dir to create and save plots in
################################################################

mkdir -p $plotdir

python $rnamap_scripts/new_scripts/plotBootstrapFits.py $cpvar $plotdir
