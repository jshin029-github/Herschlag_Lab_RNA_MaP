...
python $rnamap_scripts/new_scripts/combineCPseriesMissing.py $N_tiles $N_concs $all_CPseries_Dirs ALL_tile%03d_Bottom_filtered.CPseries "$pattern"_"$color"_all.CPseries.gz "$pattern"_"$color"_anyRNA.CPseries.gz $CPannot
