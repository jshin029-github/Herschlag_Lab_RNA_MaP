...
#################
#set a job name  
#SBATCH --job-name=fixBadClustes.sh
#SBATCH --mem=32G
#################  
#a file for job output, you can check job progress
#SBATCH --output=fixBadClusters.out
#################
# a file for errors from the job
#SBATCH --error=fixBadClusters.err
#################
...
python $rnamap_scripts/new_scripts/fixBadClusters.py $cpseriesfilename $fidcutoff $bgcutoff $csvoutfilename $plotfilename
