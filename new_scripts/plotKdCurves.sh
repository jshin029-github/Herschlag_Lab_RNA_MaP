...
#################
#set a job name  
#SBATCH --job-name=plotKdCurves
#################  
#a file for job output, you can check job progress
#SBATCH --output=plotKdCurves.out
#################
# a file for errors from the job
#SBATCH --error=plotKdCurves.err
#################
...
python $rnamap_scripts/array_fitting_tools/bin/plotBindingCurves.py -i ` cat $variantIds  ` -vp $CPvariantParams --annotate --plotinit -ex png -out $outdir
