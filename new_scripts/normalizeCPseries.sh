...
#SBATCH --output=normalizeCPseries.out
#################
# a file for errors from the job
#SBATCH --error=normalizeCPseries.err
#################
...
python $rnamap_scripst/array_fitting_tools/bin/normalizeSeries.py -b binding_series/anyRNA_Bottom_filtered_green.CPseries.gz  -r binding_series/anyRNA_Bottom_filtered_red.CPseries.gz  -out anyRNA_normed_AllRed.CPseries.gz 
