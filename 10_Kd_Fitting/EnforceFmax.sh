...
#SBATCH --output=logging/EnforceFmax-%j.out
#################
# a file for errors from the job
#SBATCH --error=logging/EnforceFmax-%j.err
#################
...
python /home/groups/herschla/rna_map/scripts/array_fitting_tools/bin/enforceFmax.py -b $cpseriesfile -v $cpvariantfile -m $fitfile -a $cpannotfile -x $concentrationsfile -out $finalfile
